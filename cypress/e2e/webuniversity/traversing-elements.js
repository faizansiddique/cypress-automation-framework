...
describe('Travesrsing DOM elements in Cypress', () => {
    beforeEach(() => {
    ...
    it('first() to retrieve first DOm elements within elements', () => {
        cy.get('.traversal-table > tbody > tr > td').first().should('contain', 'Andy')
    });

    it('last() to retrieve first DOm elements within elements', () => {
    ...
    it('parents() To get parent DOM element of elements', () => {
        cy.get('.traversal-cite').parents().should('match', 'blockquote')
    });

    it('prev() to get previos sibling DOM element within elements', () => {
    ...
    it.only('siblings() to get all sibling DOM element', () => {
